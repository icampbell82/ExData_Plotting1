...
par(mfrow = c(2,2))
with(data,plot(dateandtime,Global_active_power,type="n",ylab = "Global Active Power",xlab=""))
lines(data$dateandtime,data$Global_active_power)

with(data,plot(dateandtime,Voltage,type="n",ylab = "Voltage",xlab="datetime"))
...
with(data,plot(dateandtime,Global_reactive_power,type="n",ylab = "Global_reactive_power",xlab="datetime"))
lines(data$dateandtime,data$Global_reactive_power,lwd=.5)
